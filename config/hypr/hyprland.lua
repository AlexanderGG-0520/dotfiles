...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("uwsm app -- quickshell --path /home/alex/.config/quickshell --no-duplicate")
end)
...
hl.bind("SUPER + Print", hl.dsp.exec_cmd(
    'mkdir -p "$HOME/Pictures/Screenshots"; grim -g "$(slurp -d)" "$HOME/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png"'
))
